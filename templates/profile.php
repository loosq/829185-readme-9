        ...
        <div class="profile__tabs-wrapper tabs">
            <div class="container">
                ...
                <div class="profile__tab-content">
                        ...
                        <article class="profile__post post post-photo">
                            ...
                            <footer class="post__footer">
                                <div class="post__indicators">
                                        ...
                                        <a class="post__indicator post__indicator--likes button" title="Лайк"
                                           data-post-id='<?= $card['posts_id'] ?>'>
                                            <svg class="post__indicator-icon" width="20" height="17">
                                                <use xlink:href="#icon-heart<?= dbGetLike($con, $card['posts_id'],
                                    ...
                                    <time class="post__time" datetime="<?= date('d.m.Y H:i',
                                        strtotime($card['post_date'])) ?>"><?= showTimeGap($card['post_date']) ?> назад
                                    </time>
                                </div>
                            ...
                            <div class="comments">
                                <a class="comments__button button"
                                   href='post.php?postId=<?= $card['posts_id'] ?>#comments'>Показать комментарии</a>
                            </div>
                        </article>
                            <?php endforeach ?>
                            <?php if (empty($cards)) : ?>
                                ...
                                <?php foreach ($likers as $likeData): ?>
                                    <?php if ($likeData['type'] === 'picture'): ?>
                                        <li class="post-mini post-mini--photo post user">
                                            ...
                                            <div class="post-mini__preview">
                                                <a class="post-mini__link" href="post.php?postId=<?= $likeData['posts_id'] ?>" title="Перейти на публикацию">
                                    ...
                                    <?php elseif ($likeData['type'] === 'text'): ?>
                                        <li class="post-mini post-mini--text post user">
                                            <div class="post-mini__user-info user__info">
                                                <div class="post-mini__avatar user__avatar">
                                                    <a class="user__avatar-link" href="profile.php?user=<?= $likeData['users_id'] ?>">
                                                        <img class="post-mini__picture user__picture"
                                                             src="<?= $likeData['avatar'] ?>" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-mini__name-wrapper user__name-wrapper">
                                                    <a class="post-mini__name user__name" href="profile.php?user=<?= $likeData['users_id'] ?>">
                                                        <span><?= $likeData['name'] ?></span>
                                                    </a>
                                                    <div class="post-mini__action">
                                                        <span class="post-mini__activity user__additional">Лайкнул вашу публикацию</span>
                                    ...
                                    <?php elseif ($likeData['type'] === 'quote'): ?>
                                        <li class="post-mini post-mini--quote post user">
                                            <div class="post-mini__user-info user__info">
                                                ...
                                                <div class="post-mini__name-wrapper user__name-wrapper">
                                                    <a class="post-mini__name user__name" href="profile.php?userId=<?= $likeData['users_id'] ?>">
                                                        <span><?= $likeData['name'] ?></span>
                                                    </a>
                                                    <div class="post-mini__action">
                                                        <span class="post-mini__activity user__additional">Лайкнул вашу публикацию</span>
                    ...
                    <section class="profile__subscriptions tabs__content<?= $getTab === 'subs' ? ' tabs__content--active' : '' ?>">
                        ...
                        <ul class="profile__subscriptions-list">
                            ...
                            <li class="post-mini post-mini--photo post user">
                                <div class="post-mini__user-info user__info">
                                    <div class="post-mini__avatar user__avatar">
                                        <a class="user__avatar-link" href="profile.php?user=<?= $sub['users_id'] ?>">
                                            <img class="post-mini__picture user__picture" src="<?= $sub['avatar'] ?>"
                                                 alt="">
                                        </a>
                                    </div>
                                    <div class="post-mini__name-wrapper user__name-wrapper">
                                        <a class="post-mini__name user__name" href="profile.php?user=<?= $sub['users_id'] ?>">
                                            <span><?= $sub['name'] ?></span>
                                        </a>
                                        <time class="post-mini__time user__additional" datetime="<?= date('Y-m-d H:i', strtotime($sub['registration_date'])) ?>">
                                ...
                                <div class="post-mini__user-buttons user__buttons">
                                    <a class="profile__user-button user__button user__button--subscription button button--main"
                                       data-user-id="<?= $sub['users_id'] ?>" data-issub="<?= dbCheckSubscription($con, $userSession['user-id'],
                                        $sub['users_id']) ? '1' : '0' ?>"><span><?= dbCheckSubscription($con, $userSession['user-id'],
