                    ...
                    <?= dbGetUserChatToName($con ,$allChatsVal['users_id_send'] ,$allChatsVal['users_id_get']) ?>
                                ...
                                <div class="messages__preview">
                                    <p class="messages__preview-text">
                                        <?= (int)$allChatsVal['users_id_send'] === $userMe ? 'Вы: ' . msgTextCut($allChatsVal['text'], 15) : msgTextCut($allChatsVal['text'], 15) ?>
                                    </p>
                                    ...
                                    <div class="messages__item-avatar">
                                        <a class="messages__author-link"
                                           href="profile.php?user=<?= $userSession['user-id'] ?>">
                                            <img class="messages__avatar" src="<?=$userSession['user-ava'] ?>" alt="">
                                        </a>
                                    </div>
                                            ...
                                            <div class="messages__item-avatar">
                                                <a class="messages__author-link"
                                                   href="profile.php?user=<?= $userOther ?>">
                                                    <img class="messages__avatar" src="<?= dbGetUserAva($con, $userOther) ?>" alt="">
                                                </a>
                                            </div>
                                            <div class="messages__item-info">
                                                <a class="messages__author"
